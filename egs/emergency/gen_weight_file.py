...
parser.add_argument("--data_path", type=str, default='./data/datafiles/Emergency_train_data.json')

if __name__ == '__main__':
    args = parser.parse_args()
    data_path = args.data_path

    index_dict = make_index_dict('./data/Emergency_class_labels_indices.csv')
